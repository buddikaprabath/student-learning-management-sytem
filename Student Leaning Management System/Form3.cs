    ...
    public partial class Form3 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string sql_insert = "INSERT INTO teacher_r(ID,Name,DOB,Address,Contact)VALUES(@ID, @Name, @DOB, @Address, @Contact)";
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            con.Open();
            string id = textBox1.Text;
            string sql_search = "SELECT * from teacher_r WHERE ID='" + id + "'";
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string sql_update = "UPDATE teacher_r SET Name=@Name, DOB=@DOB, Address=@Address, Contact=@Contact WHERE ID=@ID";
        ...
        private void button6_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                SqlDataAdapter data = new SqlDataAdapter("SELECT * FROM teacher_r", con);
